...
public class ActivityCustDelVsRecReport  extends Activity{
	...
	//On create method similar to page load
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			//Code to set layout
			setContentView(R.layout.activity_cust_delvsrec_report);
...
//					}
		...
		private class AsyncCentreWSCall extends AsyncTask<String, Void, String> {
			private ProgressDialog Dialog = new ProgressDialog(ActivityCustDelVsRecReport.this);
			...
			protected void onPostExecute(String result) {
				try {
					if (!result.contains("ERROR: ")) {
						...
						common.showAlert(ActivityCustDelVsRecReport.this, result, false);
					}
				} catch (Exception e) {
					common.showAlert(ActivityCustDelVsRecReport.this, "Centre Downloading failed: " + e.toString(), false);
				}
				Dialog.dismiss();
			}
		...
		public class CustomAdapter extends BaseAdapter {
			...
			public View getView(final int arg0, View arg1, ViewGroup arg2) {
				...
				if (arg1 == null) {
					arg1 = mInflater.inflate(R.layout.list_cust_delvsrec_detail, null);
		...
		//<editor-fold desc="Async class Class to handle fetch Customerwise Delivery Receipt web service call as separate thread">
		private class AsyncCustomerwiseDeliveryReceiptListWSCall extends AsyncTask<String, Void, String> {
			private ProgressDialog Dialog = new ProgressDialog(ActivityCustDelVsRecReport.this);
			...
			protected String doInBackground(String... params) {
				try {
					...
					String[] value = {"ReadCustomerwiseDeliveryReceipt",lang,((CustomType)spCentre.getSelectedItem()).getId(),userId,  dateString, ((CustomType)spCompany.getSelectedItem()).getId()};
					responseJSON = "";
			...
			protected void onPostExecute(String result) {
				try {
					...
					common.showAlert(ActivityCustDelVsRecReport.this, "Customer wise Delivery VS Receipt Report Downloading failed: " + "Unable to get response from server.", false);
				}
				Dialog.dismiss();
			}
			...
			@Override
			protected void onPreExecute() {
				Dialog.setMessage("Downloading Customer wise Delivery VS Receipt Report..");
				Dialog.setCancelable(false);
				Dialog.show();
			}
		}
		...
		public boolean onOptionsItemSelected(MenuItem item) {
			...
			case R.id.action_go_to_home: 
				...
				if(userRole.contains("System User") || userRole.contains("Centre User") || userRole.contains("MIS User") || userRole.contains("Management User") && (!userRole.contains("Route Officer") || !userRole.contains("Collection Officer") || !userRole.contains("Accountant")))
					i = new Intent(ActivityCustDelVsRecReport.this,ActivityAdminHomeScreen.class);
				else
					i = new Intent(ActivityCustDelVsRecReport.this,ActivityHomeScreen.class);
				startActivity(i);
		...
		public void onBackPressed() {
			Intent i = new Intent(ActivityCustDelVsRecReport.this,ActivityReport.class);
			startActivity(i);
			i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
			startActivity(i);
			finish();
	...
	private class AsyncCompanyWSCall extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			try {
				...
				common.showAlert(ActivityCustDelVsRecReport.this, "Company Downloading failed: " + e.toString(), false);
			}
			Dialog.dismiss();
		}
