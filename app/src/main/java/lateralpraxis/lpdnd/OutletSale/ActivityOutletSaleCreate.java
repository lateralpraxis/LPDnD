...
import lateralpraxis.lpdnd.ActivityDeliveryPayment;
import lateralpraxis.lpdnd.ActivityDeliveryViewDetail;
...
@SuppressLint("InflateParams") public class ActivityOutletSaleCreate extends ListActivity {
						...
						public void onClick(
							...
							if (common.isConnected()) {
								try {
									...
									e.printStackTrace();
									common.showAlert(ActivityOutletSaleCreate.this, "Error in Saving delivery.\n"+e.getMessage(), false);
								}
							}
							else{
