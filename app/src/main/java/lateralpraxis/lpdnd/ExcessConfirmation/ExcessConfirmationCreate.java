...
public class ExcessConfirmationCreate extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Code to set layout
        setContentView(R.layout.excess_confirmation_view);
        ...
        db.openR();
        data = db.getExcessConfirmationHeaderData(id);
    ...
    private class AsyncExpenseConfirmationWSCall extends
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                responseJSON = common.CallJsonWS(name, value, "UpdateApprovalExcessBooking",
                        common.url);
                return responseJSON;
        ...
        protected void onPostExecute(String result) {
            try {
                if (!result.contains("ERROR")) {
                    ...
                    Intent intent = new Intent(ExcessConfirmationCreate.this, ActivityAdminHomeScreen.class);
                    startActivity(intent);
                    finish();
                } else {
                    if (result.contains("null") || result == "")
                        result = "Server not responding. Please try again later.";
                    common.showAlert(ExcessConfirmationCreate.this, result, false);
                }
            } catch (Exception e) {
                common.showAlert(ExcessConfirmationCreate.this,e.getMessage(), false);
            }
            Dialog.dismiss();
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                Intent i = new Intent(ExcessConfirmationCreate.this,ExcessConfirmationList.class);
    ...
    public void onBackPressed() {
        Intent homeScreenIntent = new Intent(ExcessConfirmationCreate.this, ExcessConfirmationList.class);
        homeScreenIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(homeScreenIntent);
        finish();
    }
