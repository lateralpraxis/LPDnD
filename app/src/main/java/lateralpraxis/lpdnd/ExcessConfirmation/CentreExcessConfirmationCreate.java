...
public class CentreExcessConfirmationCreate extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Code to set layout
        setContentView(R.layout.excess_centre_confirmation_view);
        ...
        tvCentre = (TextView) findViewById(R.id.tvCentre);
        ...
        db.openR();
        data = db.getCentreExcessConfirmationHeaderData(id);
        tvDate.setText(common.convertToDisplayDateFormat(data.split("~")[0].toString()));
        tvCentre.setText(data.split("~")[1].toString());
        tvCompany.setText(data.split("~")[2].toString());
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                alertDialogBuilder
                        .setMessage(lang.equalsIgnoreCase("hi")?"क्या आप निश्चित हैं,आप इस अतिरिक्त फंड बुकिंग को पुष्टि करना चाहते हैं?":"Are you sure, you want to confirm this excess fund booking?").setCancelable(false).setPositiveButton(lang.equalsIgnoreCase("hi")?"हाँ":"Yes",
                        new DialogInterface.OnClickListener() {
                            public void onClick(
                                ...
                                {
                                    AsyncExcessConfirmationWSCall task = new AsyncExcessConfirmationWSCall();
                                    task.execute();
                                }
                            }
    ...
    //Async Task To Call Confirm Excess Booking Data
    private class AsyncExcessConfirmationWSCall extends
            AsyncTask<String, Void, String> {
        private ProgressDialog Dialog = new ProgressDialog(
                CentreExcessConfirmationCreate.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                responseJSON = common.CallJsonWS(name, value, "UpdateApprovalCentreExcessBooking",
                        common.url);
                return responseJSON;
        ...
        protected void onPostExecute(String result) {
            try {
                if (!result.contains("ERROR")) {
                    common.showToast("Excess Fund Booking Confirmed successfully");
                    Intent intent = new Intent(CentreExcessConfirmationCreate.this, ActivityAdminHomeScreen.class);
                    startActivity(intent);
                    finish();
                } else {
                    if (result.contains("null") || result == "")
                        result = "Server not responding. Please try again later.";
                    common.showAlert(CentreExcessConfirmationCreate.this, result, false);
                }
            } catch (Exception e) {
                common.showAlert(CentreExcessConfirmationCreate.this,e.getMessage(), false);
            }
            Dialog.dismiss();
        }
        ...
        protected void onPreExecute() {
            Dialog.setMessage("Confirming Excess Fund Booking...");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                Intent i = new Intent(CentreExcessConfirmationCreate.this,CentreExcessConfirmationList.class);
    ...
    public void onBackPressed() {
        Intent homeScreenIntent = new Intent(CentreExcessConfirmationCreate.this, CentreExcessConfirmationList.class);
        homeScreenIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(homeScreenIntent);
        finish();
    }
