...
public class ActivityAdjustmentReport extends Activity {
	...
	//On create method similar to page load
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			//Code to set layout
			setContentView(R.layout.activity_adjustment_report);
			...
			listAdjust = (ListView) findViewById(R.id.listAdjust);
...
//					}
		...
		private class AsyncCentreWSCall extends AsyncTask<String, Void, String> {
			private ProgressDialog Dialog = new ProgressDialog(ActivityAdjustmentReport.this);
			...
			protected void onPostExecute(String result) {
				try {
					...
					common.showAlert(ActivityAdjustmentReport.this, "Centre Downloading failed: " + e.toString(), false);
				}
				Dialog.dismiss();
			}
		...
		public static class ViewHolder {
			TextView tvCreateBy, tvProduct, tvQuantity;
		...
		public class CustomAdapter extends BaseAdapter {
			...
			public View getView(final int arg0, View arg1, ViewGroup arg2) {
				...
				if (arg1 == null) {
					arg1 = mInflater.inflate(R.layout.list_stock_adjustment, null);
				...
				if(list.get(arg0).get("Flag").equalsIgnoreCase("1"))
					holder.tvCreateBy.setText("");
				else
					holder.tvCreateBy.setText(list.get(arg0).get("CreateBy"));
		...
		private class AsyncAdjustmentListWSCall extends AsyncTask<String, Void, String> {
			private ProgressDialog Dialog = new ProgressDialog(ActivityAdjustmentReport.this);
			...
			protected String doInBackground(String... params) {
				try {
					...
					String[] value = {"ReadStockAdjustment",lang,((CustomType)spCentre.getSelectedItem()).getId(),userId,  dateString, ((CustomType)spCompany.getSelectedItem()).getId()};
					responseJSON = "";
					...
					if (!result.contains("ERROR: ")) {
						...
						if (jsonArray.length() > 0) {
							for (int i = 0; i < jsonArray.length(); ++i) {
								...
								map.put("CreateBy", jsonArray.getJSONObject(i)
										.getString("A"));
						...
						if (listSize != 0) {
							listAdjust.setAdapter(new CustomAdapter(mContext, wordList));

							ViewGroup.LayoutParams params = listAdjust.getLayoutParams();
							listAdjust.setLayoutParams(params);
							listAdjust.requestLayout();
							tvEmpty.setVisibility(View.GONE);
						} else {
							listAdjust.setAdapter(null);
							tvEmpty.setVisibility(View.VISIBLE);
						}
					}
				} catch (Exception e) {
					common.showAlert(ActivityAdjustmentReport.this, "Stock Adjustment Downloading failed: " + "Unable to get response from server.", false);
				}
				Dialog.dismiss();
			}
		...
		public boolean onOptionsItemSelected(MenuItem item) {
			...
			case R.id.action_go_to_home: 
				...
				if(userRole.contains("System User") || userRole.contains("Centre User") || userRole.contains("MIS User") || userRole.contains("Management User") && (!userRole.contains("Route Officer") || !userRole.contains("Collection Officer") || !userRole.contains("Accountant")))
					i = new Intent(ActivityAdjustmentReport.this,ActivityAdminHomeScreen.class);
				else
					i = new Intent(ActivityAdjustmentReport.this,ActivityHomeScreen.class);
				startActivity(i);
		...
		public void onBackPressed() {
			Intent i = new Intent(ActivityAdjustmentReport.this,ActivityReport.class);
			startActivity(i);
			i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
			startActivity(i);
			finish();
	...
	private class AsyncCompanyWSCall extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			try {
				...
				common.showAlert(ActivityAdjustmentReport.this, "Company Downloading failed: " + e.toString(), false);
			}
			Dialog.dismiss();
		}
