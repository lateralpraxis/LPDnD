...
public class ActivityConversionView extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conversion_view);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_go_to_home:
                Intent i = new Intent(ActivityConversionView.this, ActivityAdminHomeScreen.class);
                startActivity(i);
    ...
    //<editor-fold desc="Code to be executed on Back">
    @Override
    public void onBackPressed() {
        Intent i = new Intent(ActivityConversionView.this, ActivityListCentreConversion.class);
        startActivity(i);
        i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(i);
        finish();
