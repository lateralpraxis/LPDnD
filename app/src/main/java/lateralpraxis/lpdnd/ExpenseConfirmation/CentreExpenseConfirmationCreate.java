...
public class CentreExpenseConfirmationCreate extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Code to set layout
        setContentView(R.layout.expense_centre_confirmation_view);
        ...
        db.openR();
        data = db.getCentreExpenseConfirmationHeaderData(id);
    ...
    private class AsyncExpenseConfirmationWSCall extends
        ...
        private ProgressDialog Dialog = new ProgressDialog(
                CentreExpenseConfirmationCreate.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                responseJSON = common.CallJsonWS(name, value, "UpdateApprovalCentreExpenseBooking",
                        common.url);
                return responseJSON;
        ...
        protected void onPostExecute(String result) {
            try {
                if (!result.contains("ERROR")) {
                    ...
                    Intent intent = new Intent(CentreExpenseConfirmationCreate.this, ActivityAdminHomeScreen.class);
                    startActivity(intent);
                    finish();
                } else {
                    if (result.contains("null") || result == "")
                        result = "Server not responding. Please try again later.";
                    common.showAlert(CentreExpenseConfirmationCreate.this, result, false);
                }
            } catch (Exception e) {
                common.showAlert(CentreExpenseConfirmationCreate.this,e.getMessage(), false);
            }
            Dialog.dismiss();
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                Intent i = new Intent(CentreExpenseConfirmationCreate.this,CentreExpenseConfirmationList.class);
    ...
    public void onBackPressed() {
        Intent homeScreenIntent = new Intent(CentreExpenseConfirmationCreate.this, CentreExpenseConfirmationList.class);
        homeScreenIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(homeScreenIntent);
        finish();
    }
