...
public class ActivityPaymentView extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        final String custNameString = String.valueOf(((TextView) v.findViewById(R.id.tvCustomerName)).getText().toString());
    ...
    public void BindPaymentReport() {
       ...
       /*     if(repDate.equals(common.formateDateFromstring("yyyy-MM-dd", "dd-MMM-yyyy", lables.get(i).getDate())) && custName.equals(String.valueOf(lables.get(i).getName())))
                hm.put("name", "");
            else*/
                hm.put("name", String.valueOf(lables.get(i).getName()));
            if (repDate.equals(common.formateDateFromstring("yyyy-MM-dd", "dd-MMM-yyyy", lables.get(i).getDate())))
                hm.put("date", "");
            else
                hm.put("date", common.formateDateFromstring("yyyy-MM-dd", "dd-MMM-yyyy", lables.get(i).getDate()));
            hm.put("exdate", lables.get(i).getDate());
            hm.put("custName",String.valueOf(lables.get(i).getName()));
            repDate = common.formateDateFromstring("yyyy-MM-dd", "dd-MMM-yyyy", lables.get(i).getDate());
            custName = String.valueOf(lables.get(i).getName());
            aList.add(hm);
        }
        db.close();
        // Keys used in Hashmap
        String[] from = {"id", "name", "date", "exdate","custName"};
        // Ids of views in listview_layout
        int[] to = {R.id.tvId, R.id.tvName, R.id.tvDate, R.id.tvMainDate, R.id.tvCustomerName};
